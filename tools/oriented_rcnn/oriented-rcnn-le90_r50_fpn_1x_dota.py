_base_ = ["../_base_/datasets/dota.py", "../_base_/schedules/schedule_1x.py", "../_base_/default_runtime.py"]
...
model = dict(
    ...
    train_cfg=dict(
        rpn=dict(
            ...
            sampler=dict(
                type="mmdet.RandomSampler", num=256, pos_fraction=0.5, neg_pos_ub=-1, add_gt_as_proposals=False
            ),
            allowed_border=0,
            pos_weight=-1,
            debug=False,
        ...
        rcnn=dict(
            ...
            sampler=dict(
                type="mmdet.RandomSampler", num=512, pos_fraction=0.25, neg_pos_ub=-1, add_gt_as_proposals=True
            ),
            pos_weight=-1,
            debug=False,
        ),
    ...
    test_cfg=dict(
        ...
        rcnn=dict(
            ...
            min_bbox_size=0,
            score_thr=0.05,
            nms=dict(type="mmrotate.nms_rotated", iou_threshold=0.1),
            max_per_img=2000,
        ),
    ),
)
